...
#   Module:             AirodynCV
#   Sub Module:         utils
#   File Name:          variableCNN_train.py
...
class TFAnnotation:
    """Tensorflow-Compatible data-point to add to record dataset"""
    def __init__(self):
        # initialize bounding box and label list
        self.xMins = []
        self.xMaxs = []
        self.yMins = []
        self.yMaxs = []
        self.textLabels = []        # Class labels in text
        self.classes = []           # Integer IDs for class labels
        self.difficult = []

        # Initialize image, spatial information, encoding and filename
        self.image = None
        self.width = None
        self.height = None
        self.encoding = None        # Encoding - .jpg/.png/.tiff
        self.filename = None

    def build(self):
        # encoding attributes using TensorFlow encoding function
        ...
        # constructing the TensorFlow data dictionary
        data = {
            "image/height": h,
            "image/width": w,
